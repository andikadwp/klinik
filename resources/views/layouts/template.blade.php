        ...
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{ url('/laporan') }}" class="site_title"><i class='fa fa-hospital-o'></i> <span>Klinik
                                Sehat</span></a>
                    </div>
                    ...
                    <div class="profile clearfix">
                        <div class="profile_info ml-3">
                            ...
                            @can('isSuperAdmin')
                            <span>Admin<br></span>
                            <a style="font-size:13px"> {{ Auth::user()->email }}</a>
                            @endcan
                        </div>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="top_nav">
                <div class="nav_menu">
                    ...
                    <div class="navbar-text pull-right my-2 mx-4">
                    <a data-toggle="tooltip" data-placement="top" title="Logout" href="login.html" style="font-size:120%;" href="{{ route('logout') }}"onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
            ...
            <footer>
                <div class="pull-right">
                    <span>Copyright &copy; Klinik Sehat <?= Date('Y') ?></span>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
